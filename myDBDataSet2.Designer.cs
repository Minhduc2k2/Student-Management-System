...
namespace LoginForm.myDBDataSet2TableAdapters {
...
SELECT id, label, period, description FROM course WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::LoginForm.Properties.Settings.Default.myDBConnectionString;
        }
        ...
        public virtual int Fill(myDBDataSet2.courseDataTable dataTable) {
        ...
        public virtual myDBDataSet2.courseDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            myDBDataSet2.courseDataTable dataTable = new myDBDataSet2.courseDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(myDBDataSet2.courseDataTable dataTable) {
        ...
        public virtual int Delete(string Original_id, string Original_label, int Original_period) {
            if ((Original_id == null)) {
        ...
        public virtual int Insert(string id, string label, int period, string description) {
            if ((id == null)) {
        ...
        public virtual int Update(string id, string label, int period, string description, string Original_id, string Original_label, int Original_period) {
            if ((id == null)) {
                throw new global::System.ArgumentNullException("id");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string label, int period, string description, string Original_id, string Original_label, int Original_period) {
